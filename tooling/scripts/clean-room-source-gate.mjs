...
const EXACT_ALLOWLIST = new Map([
  ...[
    ...
    "apps/desktop/src-tauri/src/plugins/model.rs",
    "apps/desktop/src-tauri/src/extensions/runtime_contributor/claude_hook_tests.rs",
  ].map(path => [path, {
  ...
  ["apps/desktop/src-tauri/src/app_settings.rs", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/src-tauri/src/extensions/agent_catalog.rs", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/src-tauri/src/extensions/marketplace_source.rs", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/src-tauri/prompts/agents/plan.md", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/src-tauri/prompts/agents/explore.md", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
