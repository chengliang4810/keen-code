...
const EXACT_ALLOWLIST = new Map([
  ...[
    "core/skills/src/template.rs",
    "apps/desktop/src/plugins/model.rs",
    "apps/desktop/src/extensions/runtime_contributor/claude_hook_tests.rs",
  ].map(path => [path, {
  ...
  ...["apps/ui/src/i18n/messages.ts", "apps/ui/src/i18n/zh-tw.ts"].map(path => [path, {ruleIds: new Set([SOURCE_RULE_IDS.externalProduct]), purpose: "显示用户要求恢复的内置网络服务地址"}]),
  ["apps/desktop/src/app_settings.rs", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/src/extensions/agent_catalog.rs", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/src/extensions/marketplace_source.rs", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/prompts/agents/plan.md", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/prompts/agents/explore.md", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/prompts/agents/general-purpose.md", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ["apps/desktop/prompts/agents/verification.md", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "用户明确要求恢复内置网络服务、上游代理提示词及官方插件市场" }],
  ...["apps/desktop/prompts/agents/SOURCE.md", "apps/desktop/prompts/agents/UPSTREAM-LICENSE.txt"].map(path => [path, { ruleIds: new Set([...LEGAL_ATTRIBUTION_RULE_IDS, SOURCE_RULE_IDS.proprietaryPluginRepository]), purpose: "保留用户指定上游的来源和完整版权许可声明" }]),
  ["apps/desktop/prompts/README.md", { ruleIds: new Set([SOURCE_RULE_IDS.externalProduct]), purpose: "来源说明文档：记录用户指定上游的基线与提炼规则，本身即是披露证据" }],
