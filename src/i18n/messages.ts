...
const en = {
  ...
  "backgroundTasks.cancel": "Cancel background task",
  "backgroundTasks.cancelAll": "Cancel all background tasks",
  "backgroundTasks.kind.shell": "Terminal process",
  "backgroundTasks.kind.agent": "Subagent",
  "backgroundTasks.kind.workflow": "Workflow",
...
"media.loadError": "Could not load this media in the app preview.",
  ...
  "settings.autoArchiveOldTasks": "Automatically archive old tasks",
  "settings.autoArchiveOldTasksDesc":
    "Periodically scan recently opened workspaces and archive completed, read, unpinned tasks after the retention period.",
  "settings.archiveRetention": "Archive retention",
  "settings.archiveRetentionDesc":
    "A task becomes eligible for automatic archiving only after its last update is older than this period. Default: 7 days.",
  "settings.archiveRetentionDays": "{days} days",
  ...
  "settings.aboutOpenDesc":
    "KeenCode does not require a specific model vendor. Choose and configure the compatible AI service that fits your workflow.",
  ...
  "settings.aboutWorkflowTitle": "A complete, reviewable workflow",
  "settings.aboutWorkflowDesc":
    "Follow code understanding, file edits, terminal commands, diffs, Git operations, tool calls, and task results from a single workspace.",
  ...
  "agents.model.followSession": "Inherit default",
...
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "summary.loading": "Loading git status…",
  "summary.git.needProject": "Select a project folder to see git status.",
  "summary.git.desktopOnly": "Git actions require the KeenCode desktop app.",
  "summary.git.unavailable": "Git status is unavailable.",
  ...
  "chat.turnMetrics.label": "Turn latency and cache hit rate",
  ...
  "chat.turnMetrics.cacheHit": "Cache hit {value}",
...
const zh: Record<MessageKey, string> = {
  ...
  "backgroundTasks.cancel": "停止后台任务",
  "backgroundTasks.cancelAll": "停止所有后台任务",
  "backgroundTasks.kind.shell": "终端进程",
  "backgroundTasks.kind.agent": "子智能体",
  "backgroundTasks.kind.workflow": "工作流",
  "error.details": "详情",
...
"media.loadError": "应用内无法加载此媒体。",
  ...
  "settings.autoArchiveOldTasks": "自动归档旧任务",
  "settings.autoArchiveOldTasksDesc":
    "定时扫描最近打开过的工作区，将已完成、无未读且未置顶的旧任务自动归档。",
  "settings.archiveRetention": "归档保留时长",
  "settings.archiveRetentionDesc":
    "任务最后更新时间早于该时长后，才会进入自动归档候选。默认 7 天后归档。",
  ...
  "settings.aboutWorkflowTitle": "完整且可审查的编码工作流",
  "settings.aboutWorkflowDesc":
    "在一个工作台中查看代码理解、文件修改、终端命令、Diff、Git 操作、工具调用与任务结果。",
  ...
  "agents.model.followSession": "继承默认",
...
"error.needTauri": "需要在 Tauri 窗口中选择目录",
  ...
  "summary.loading": "正在加载 git 状态…",
  "summary.git.needProject": "请先选择项目文件夹以查看 git 状态。",
  "summary.git.desktopOnly": "Git 操作需要 KeenCode 桌面应用。",
  "summary.git.unavailable": "无法获取 git 状态。",
  ...
  "chat.turnMetrics.label": "本轮延迟与缓存命中率",
  ...
  "chat.turnMetrics.cacheHit": "缓存命中 {value}",
