...
const en = {
  ...
  "prov.chatOutputTokenFieldHint": "Choose the field accepted by your gateway. Only this field is sent.",
  "prov.readTimeout": "Response wait timeout (seconds)",
  "prov.readTimeoutHint": "Wait for response headers or the next data chunk. Continuous output has no overall time limit.",
  "prov.err.readTimeout": "Response wait timeout must be an integer from 1 to 3600 seconds.",
...
"media.loadError": "Could not load this media in the app preview.",
  ...
  "settings.group.extensions": "Agent capabilities",
  ...
  "compact.waterLevel": "Context usage {level}% (threshold {threshold}%)",
...
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "message.revertFiles": "Also restore files changed by this turn and its subagents",
  "message.send": "Send",
...
const zh: Record<MessageKey, string> = {
  ...
  "prov.chatOutputTokenFieldHint": "选择网关支持的字段，请求仅发送所选字段。",
  "prov.readTimeout": "响应等待超时（秒）",
  "prov.readTimeoutHint": "限制等待响应头或下一批数据的时间，持续输出不设整轮截止。",
  "prov.err.readTimeout": "响应等待超时必须为 1 到 3600 的整数秒。",
...
"media.loadError": "应用内无法加载此媒体。",
  ...
  "compact.waterLevel": "上下文用量 {level}%（阈值 {threshold}%）",
  "compact.tokensRange": "{before} → {after} tokens",
...
"error.needTauri": "需要在 Tauri 窗口中选择目录",
  ...
  "message.revertFiles": "同时恢复本轮及其子 Agent 修改的文件",
  "message.send": "发送",
  "message.sending": "发送中…",
  "message.copied": "已复制",
  "chat.thinking": "思考中…",
