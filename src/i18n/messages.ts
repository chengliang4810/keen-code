...
const en = {
  ...
  "sidebar.plugins": "Plugin marketplace",
  "sidebar.projects": "Projects",
  "sidebar.pinned": "Pinned",
  "sidebar.addProject": "Add project",
  "sidebar.projectMoved": "Moved “{name}” to position {position} of {total}.",
  "sidebar.collapseAllProjects": "Collapse all projects",
  "sidebar.sort": "Sort conversations",
  "sidebar.sortByLastUserMessage": "Last user message",
  "sidebar.sortByUpdatedAt": "Last updated",
  ...
  "sidebar.otherSessions": "Conversations",
  ...
  "addProject.namePlaceholder": "Project name",
  "addProject.sourceFolder": "Existing project folder (optional)",
  "addProject.chooseFolder": "Choose an existing project folder",
  "addProject.defaultLocation": "KeenCode will create the project at {path}",
  "addProject.changeDefaultLocation": "Change in settings",
  "addProject.nameRequired": "Enter a project name.",
  "addProject.existingSelected": "Selected existing project “{name}”.",
  "addProject.folderOnly": "Choose a folder to add as a project.",
  "addProject.oneFolderOnly": "Add one folder at a time.",
  "addProject.submit": "Create project",
  "addProject.adding": "Creating…",

  "session.pin": "Pin chat",
  "session.unpin": "Unpin chat",
  "session.pinned": "Pinned",
  "session.justNow": "now",
  "session.minutesAgo": "{minutes}m",
  "session.hoursAgo": "{hours}h",
  "session.daysAgo": "{days}d",
  ...
  "session.placeholderTitle": "New conversation",
  "session.untitled": "Untitled",
  "session.empty": "This conversation has no messages yet.",
  ...
  "main.startTitle": "What would you like to work on?",
  "main.greeting.morningEarly": "Good morning, ready when you are",
  "main.greeting.morning": "Good morning, how can I help?",
  "main.greeting.noon": "Taking a noon break?",
  "main.greeting.afternoon": "Good afternoon, leave the rest to me.",
  "main.greeting.evening": "Good evening, nice work today",
  "main.greeting.lateNight": "It is late; take care of yourself.",
  ...
  "resources.openTab": "Open a tab",
  "resources.openTabHint": "Choose what to open in the side panel.",
  ...
  "trajectory.metrics.reasoningTokens": "Reasoning tokens {value}",
  ...
  "prov.chatOutputTokenField": "Chat output budget field",
...
"media.loadError": "Could not load this media in the app preview.",
  ...
  "composer.inputLabel": "Task prompt",
  "composer.add": "Add",
  ...
  "composer.attachRetry": "Retry upload",
  "composer.attachUploading": "Uploading",
  "composer.attachFailed": "Upload failed",
  "composer.mentionEmpty": "No matching references",
  "composer.mentionLoading": "Loading plugin references…",
  "composer.send": "Send",
  "composer.sendNeedsReadyAttachments": "Wait for attachments to finish uploading",
  "composer.sendNeedsModel": "Add a model before sending",
  "composer.sendNeedsContent": "Enter a task or attach a file",
  "composer.sendUnavailable": "Sending is unavailable while the session is busy",
  ...
  "composer.queueDrag": "Drag to reorder",
  ...
  "composer.modelVision": "Vision",
  "composer.addModel": "Add model",
  "composer.manageModels": "Manage models",
  "composer.effort": "Reasoning",
  "composer.ultra": "Ultra",
  "composer.ultraDescription": "Proactively delegate complex work to specialized Agents",
  ...
  "attach.droppedNone": "Could not read those paths. Try again from Finder.",
  ...
  "resources.browserAddress": "Address",
  ...
  "search.newChat": "New conversation",
  ...
  "settings.nav.observability": "Runtime observability",
  ...
  "settings.webHost.statusDesc":
    "The Web Host binds only to its configured address and never returns the browser Token.",
  "settings.webHost.state.unknown": "Unavailable",
  "settings.webHost.state.disabled": "Disabled",
  "settings.webHost.state.stopped": "Stopped",
  "settings.webHost.state.running": "Running",
  ...
  "settings.webHost.tokenDesc":
    "Stored in the operating system credential store. It is never written to app settings, logs, or responses.",
  "settings.webHost.tokenPlaceholder": "Enter a Token with at least 8 characters",
  "settings.webHost.tokenSave": "Save Token",
  "settings.webHost.tokenSaving": "Saving…",
  "settings.webHost.tokenSaved": "Token saved",
  "settings.webHost.tokenVersion": "Active authentication version {version}",
  ...
  "settings.archive.retentionDesc": "Chats are eligible after their last update exceeds this period.",
  "settings.archive.afterDays": "Archive after {days} days",
  ...
  "settings.archived.noProject": "Conversations",
  ...
  "settings.wallpaperVisibility": "Background visibility",
  "settings.wallpaperBlur": "Background blur",
  "settings.wallpaperAppearanceReset": "Restore default",
  "settings.wallpaperScrimDesc":
    "Lower visibility and more blur make text easier to read.",
  ...
  "prov.modelId": "Model name",
  "prov.modelAddHint": "The model is added to this provider's draft. Save the provider to apply it.",
  "prov.modelEditHint": "Changes update the draft. Save the provider to apply them.",
  "prov.removeModel": "Remove model {model}",
  "prov.contextWindow": "Context window (tokens)",
  "prov.maxOutputTokens": "Maximum output tokens",
  "prov.editModel": "Edit model",
  "prov.applyModel": "Apply changes",
  "prov.err.outputTokens": "Maximum output tokens must be an integer between 1 and 4294967295.",
  ...
  "prov.copy": "Copy config",
  "prov.copyDone": "Provider config copied as JSON.",
  "prov.copyFail": "Copy failed: {error}",
  ...
  "prov.importHint":
    "Select an exported provider JSON file. Providers with the same ID are updated, others are added. The active provider stays unchanged.",
  "prov.importPickFile": "Choose file…",
  "prov.importPickHint": "JSON files only",
  "prov.importParsed": "{n} provider(s) found in file.",
  "prov.importSubmit": "Import",
  "prov.importWorking": "Importing…",
  "prov.importDone": "Imported {added} provider(s), updated {updated}.",
  "prov.importFail": "Import failed: {error}",
  "prov.importErr.json": "The file is not valid JSON.",
  ...
  "shortcuts.newChat": "New conversation",
  ...
  "goal.objectiveTooLong": "A goal objective cannot exceed 65536 UTF-8 bytes",
  "compact.bannerAuto": "Context auto-compacted",
  "compact.bannerManual": "Context compacted",
  "compact.bannerRunning": "Compacting context…",
  "compact.bannerFailed": "Context compaction failed",
  ...
  "ext.plugins.browseMarket": "Browse plugin marketplace",
  ...
  "agents.tools.specificHint": "Choose the tools this subagent can use",
  "agents.tools.empty": "No tools available",
  "agents.injectAgentsMd": "Inject AGENTS.md",
  "agents.injectAgentsMdHint": "Include project instructions in this subagent's context",
  ...
  "ext.market.addEmpty":
    "Enter a local directory, GitHub repository, package source, or marketplace JSON URL.",
  ...
  "ext.market.paginationLabel": "Plugin marketplace pages",
  "ext.market.previousPage": "Previous",
  "ext.market.nextPage": "Next",
  "ext.market.pageStatus": "{page} / {pages}",
  "ext.market.error": "Marketplace action failed",
  "ext.compatibility.title": "Compatibility",
  "ext.compatibility.description": "Map plugin Agent model aliases to your configured models. All aliases inherit the current model by default. If a selected model or provider is deleted, the alias inherits the current model again.",
  "ext.compatibility.loadFailed": "Could not load compatibility settings. Close and reopen to retry.",
  "ext.compatibility.saveFailed": "Could not save compatibility settings. Please retry.",
  "ext.market.installed": "Installed",
  "ext.market.manage": "Manage",
  "ext.market.loadFailed": "Unable to load the plugin marketplace. Check your network connection or system proxy, then refresh to retry.",
  "ext.market.addFailed": "Unable to add the marketplace. Check the source address and network connection, then retry.",
  "ext.market.removeFailed": "Unable to remove the marketplace. Refresh and retry.",
  "ext.market.installFailed": "Unable to install the plugin. Check the plugin source and network connection, then retry.",
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "summary.branches.open": "Choose branch",
  "summary.branches.search": "Search branches",
  "summary.branches.title": "Branches",
  "summary.branches.uncommitted": "{count} uncommitted files",
  "summary.branches.create": "Create and check out new branch…",
  "summary.branches.createTitle": "Create and check out branch",
  "summary.branches.name": "Branch name",
  "summary.branches.invalid": "Branch name cannot be empty or end with “/”.",
  "summary.branches.createAction": "Create and check out",
  ...
  "summary.subagents.stop": "Stop subagent {name}",
  "summary.subagents.stopFailed": "Failed to stop subagent: {error}",
  "summary.subagents.running": "Running ({count})",
  "summary.subagents.failed": "Needs attention ({count})",
  "summary.subagents.interrupted": "Interrupted ({count})",
  ...
  "settings.personalization.description":
    "Changes apply from the next turn after saving. No restart is needed.",
  "settings.personalization.learnMore": "Learn more",
  "settings.personalization.help":
    "KeenCode reads this file before each main or subagent turn. When you use a remote model, its contents are sent to your configured model provider.",
  ...
  "settings.requests.reasoningTokens": "Reasoning tokens",
  ...
  // Settings -> Runtime observability
  "settings.observability.title": "Runtime observability",
  "settings.observability.description":
    "Inspect bounded, local-only runtime metrics, traces, startup phases, resources, and crash summaries.",
  "settings.observability.refresh": "Refresh",
  "settings.observability.refreshing": "Refreshing…",
  "settings.observability.export": "Export redacted JSON",
  "settings.observability.exporting": "Exporting…",
  "settings.observability.loading": "Loading runtime observations…",
  "settings.observability.unavailable": "Runtime observations are unavailable.",
  "settings.observability.events": "Events",
  "settings.observability.traces": "Traces",
  "settings.observability.ttftP50": "TTFT p50",
  "settings.observability.ttftP95": "TTFT p95",
  "settings.observability.resources": "Resource samples",
  "settings.observability.crashes": "Crash records",
  "settings.observability.dropped": "Dropped realtime events",
  "settings.observability.startup": "Startup phases",
  "settings.observability.latestResource": "Latest resource sample",
  "settings.observability.latestTrace": "Recent traces",
  "settings.observability.latestCrash": "Latest crash",
  "settings.observability.noData": "Not reported",
  "settings.observability.noCrashes": "No crashes recorded",
  "settings.observability.noResources": "No resource samples",
  "settings.observability.noStartup": "No startup phases",
  "settings.observability.metric": "Trace",
  "settings.observability.count": "Count",
  "settings.observability.average": "Average",
  "settings.observability.range": "Range",
  "settings.observability.cpu": "CPU",
  "settings.observability.processMemory": "Process memory",
  "settings.observability.privateMemory": "Private memory",
  "settings.observability.processCount": "Tracked processes",
  "settings.observability.frontendMemory": "Frontend heap",
  "settings.observability.domNodes": "DOM nodes",
  "settings.observability.eventLoopLag": "Event loop lag",
  "settings.observability.longTasks": "Long tasks",
  "settings.observability.phase": "Phase",
  "settings.observability.elapsed": "Elapsed",
  "settings.observability.status": "Status",
  "settings.observability.time": "Time",
  ...
  "chat.lastedFor": "Took {duration}",
  "chat.workingFor": "Working {duration}",
  "chat.workedFor": "Worked {duration}",
  "chat.modelSwitched": "⇄ Switched {previous} → {model}",
  "chat.retryingAttempt": "Request attempt {attempt}/{max} in progress",
  "chat.turnMetrics.label": "Turn latency",
  "chat.turnMetrics.usage": "Turn usage",
  "chat.turnMetrics.usageValue": "Usage {value}",
  "chat.turnMetrics.time": "Turn time",
  "chat.turnMetrics.timeValue": "Time {value}",
  "chat.turnMetrics.input": "Input tokens (including cache)",
  "chat.turnMetrics.output": "Output tokens",
  "chat.turnMetrics.reasoning": "Reasoning tokens (part of output)",
  "chat.turnMetrics.cacheRead": "Cache read tokens",
  "chat.turnMetrics.outputSpeed": "Output speed (TPS)",
  "chat.turnMetrics.unknown": "Not reported",
  "chat.turnMetrics.noUsage": "Some requests did not report usage; a complete turn total is unavailable.",
  "chat.turnMetrics.notObserved": "Usage was not recorded for this turn.",
  "tool.imageViewed": "Viewed 1 image",
  "tool.imagesViewed": "Viewed {count} images",
  "tool.imageNumber": "Image {count}",
  "chat.turnMetrics.totalTime": "Total duration",
  "chat.turnMetrics.firstTokenLabel": "Time to first token",
  "chat.turnMetrics.seconds": "{seconds}s",
  "chat.turnMetrics.minutes": "{minutes}m {seconds}s",
  "chat.turnMetrics.acknowledged": "Ack {value}",
  "chat.turnMetrics.firstSse": "First SSE {value}",
  "chat.turnMetrics.firstToken": "First token {value}",
  ...
  "chat.error.compactUnavailable":
    "KeenCode could not reduce the conversation context. Start a new conversation or choose another model.",
  ...
  "chat.error.providerReloadFailed":
    "The model configuration could not be loaded. Check the provider settings and retry.",
  ...
  "chat.codeLangText": "Plain text",
  "chat.codeWrap": "Wrap lines",
  "chat.codeUnwrap": "No wrap",
  "chat.codePreview": "Open diagram preview",
  "chat.codePreviewTitle": "Diagram preview",
  "chat.codePreviewDescription": "Interactive diagram preview",
  "chat.codePreviewLoading": "Rendering diagram…",
  "chat.codePreviewZoomIn": "Zoom in",
  "chat.codePreviewZoomOut": "Zoom out",
  "chat.codePreviewReset": "Reset zoom",
...
const zh: Record<MessageKey, string> = {
  ...
  "sidebar.noArchivedSessions": "暂无已归档对话",
  ...
  "addProject.name": "项目名称",
  "addProject.namePlaceholder": "项目名称",
  "addProject.sourceFolder": "已有项目文件夹（可选）",
  "addProject.chooseFolder": "选择已有项目文件夹",
  "addProject.defaultLocation": "KeenCode 将在 {path} 创建项目",
  "addProject.changeDefaultLocation": "前往设置修改",
  "addProject.nameRequired": "请输入项目名称。",
  "addProject.existingSelected": "该目录已是项目，已选择“{name}”。",
  "addProject.folderOnly": "请选择一个文件夹作为项目。",
  "addProject.oneFolderOnly": "每次只能添加一个文件夹。",
  "addProject.submit": "创建项目",
  "addProject.adding": "正在创建…",

  "session.pin": "置顶会话",
  "session.unpin": "取消置顶",
  "session.pinned": "已置顶",
  "session.justNow": "刚刚",
  "session.minutesAgo": "{minutes}分",
  "session.hoursAgo": "{hours}小时",
  "session.daysAgo": "{days}天",
  "session.rename": "重命名",
  ...
  "session.menu": "会话菜单",
  "session.new": "新对话",
  "session.placeholderTitle": "新对话",
  "session.untitled": "未命名",
  "session.empty": "当前对话还没有消息。",
  "session.fork": "分叉会话",
  ...
  "main.startTitle": "今天想从哪里开始？",
  "main.greeting.morningEarly": "早上好，新的一天准备开始吧",
  "main.greeting.morning": "上午好，今天想让我帮你做什么？",
  "main.greeting.noon": "中午好，准备好继续了吗？",
  "main.greeting.afternoon": "下午好，接下来的工作交给我吧",
  "main.greeting.evening": "晚上好，今天辛苦了",
  "main.greeting.lateNight": "夜深了，也别忘了照顾好自己",
  ...
  "resources.openTab": "打开标签页",
  "resources.openTabHint": "选择要在侧边面板中打开的标签。",
  ...
  "trajectory.metrics.reasoningTokens": "推理 Token {value}",
  ...
  "prov.chatOutputTokenField": "Chat 输出预算字段",
...
"media.loadError": "应用内无法加载此媒体。",
  ...
  "composer.sendNeedsReadyAttachments": "请等待附件上传完成",
  "composer.send": "发送",
  "composer.sendNeedsModel": "请先添加模型",
  "composer.sendNeedsContent": "请输入任务或添加附件",
  "composer.sendUnavailable": "会话忙碌时暂时无法发送",
  ...
  "composer.attachRetry": "重试上传",
  "composer.attachUploading": "正在上传",
  "composer.attachFailed": "上传失败",
  "composer.mentionEmpty": "没有匹配的引用",
  "composer.mentionLoading": "正在加载插件引用…",
  ...
  "attach.droppedNone": "无法读取这些路径，请从访达再试一次。",
  "attach.details": "详情",
  ...
  "settings.webHost.statusDesc":
    "Web Host 只绑定配置的地址，不会返回浏览器 Token。",
  "settings.webHost.state.unknown": "不可用",
  "settings.webHost.state.disabled": "已禁用",
  "settings.webHost.state.stopped": "已停止",
  "settings.webHost.state.running": "运行中",
  ...
  "settings.webHost.token": "Web Host Token",
  "settings.webHost.tokenDesc":
    "Token 保存在操作系统凭据库中，不会写入普通设置、日志或响应。",
  "settings.webHost.tokenPlaceholder": "输入至少 8 个字符的 Token",
  "settings.webHost.tokenSave": "保存 Token",
  "settings.webHost.tokenSaving": "正在保存…",
  "settings.webHost.tokenSaved": "Token 已保存",
  "settings.webHost.tokenVersion": "当前认证版本 {version}",
  ...
  "settings.archive.retentionDesc": "对话最后更新时间超过该时长后进入自动归档候选。",
  "settings.archive.afterDays": "{days} 天后归档",
  ...
  "settings.archived.noProject": "对话",
  ...
  "settings.wallpaperVisibility": "背景可见度",
  "settings.wallpaperBlur": "背景模糊",
  "settings.wallpaperAppearanceReset": "恢复默认",
  "settings.wallpaperScrimDesc":
    "降低可见度或增加模糊可以让文字更容易阅读。",
  ...
  "prov.addModel": "添加模型",
  "prov.modelId": "模型名称",
  "prov.modelAddHint": "添加到当前供应商的草稿列表，保存供应商后生效。",
  "prov.modelEditHint": "修改先应用到草稿，保存供应商后生效。",
  "prov.removeModel": "移除模型 {model}",
  "prov.contextWindow": "上下文窗口（Token）",
  "prov.maxOutputTokens": "最大输出 Token",
  "prov.editModel": "编辑模型",
  "prov.applyModel": "应用修改",
  "prov.err.outputTokens": "最大输出 Token 必须是 1 到 4294967295 之间的整数。",
  ...
  "prov.copy": "复制供应商信息",
  "prov.copyDone": "供应商信息已复制为 JSON。",
  "prov.copyFail": "复制失败：{error}",
  ...
  "prov.importHint":
    "选择导出的供应商 JSON 文件。标识相同的供应商会被更新，其余新增；不会改变当前使用的供应商。",
  "prov.importPickFile": "选择文件…",
  "prov.importPickHint": "仅支持 JSON 文件",
  "prov.importParsed": "文件中包含 {n} 个供应商。",
  "prov.importSubmit": "导入",
  "prov.importWorking": "导入中…",
  "prov.importDone": "已导入 {added} 个供应商，更新 {updated} 个。",
  "prov.importFail": "导入失败：{error}",
  ...
  "goal.objectiveTooLong": "目标正文不能超过 65536 个 UTF-8 字节",
  "compact.bannerAuto": "上下文已自动压缩",
  "compact.bannerManual": "上下文已压缩",
  "compact.bannerRunning": "上下文压缩中…",
  "compact.bannerFailed": "上下文压缩失败",
  "compact.tokensRange": "{before} → {after} tokens",
  ...
  "ext.plugins.browseMarket": "浏览插件市场",
  ...
  "agents.tools.specificHint": "选择此子智能体可以调用的工具",
  "agents.tools.empty": "没有可用工具",
  "agents.injectAgentsMd": "注入 AGENTS.md",
  "agents.injectAgentsMdHint": "将项目指令加入此子智能体的上下文",
  ...
  "ext.market.addEmpty": "请输入本地目录、GitHub 仓库、包来源或市场 JSON URL。",
  ...
  "ext.market.paginationLabel": "插件市场分页",
  "ext.market.previousPage": "上一页",
  "ext.market.nextPage": "下一页",
  "ext.market.pageStatus": "第 {page} / {pages} 页",
  "ext.market.error": "市场操作失败",
  "ext.compatibility.title": "适配设置",
  "ext.compatibility.description": "配置插件 Agent 的模型别名。默认继承当前模型；所选供应商或模型被删除后，也会自动继承当前模型。",
  "ext.compatibility.loadFailed": "无法加载适配设置，请关闭后重新打开。",
  "ext.compatibility.saveFailed": "无法保存适配设置，请重试。",
  "ext.market.installed": "已安装",
  "ext.market.manage": "管理",
  "ext.market.loadFailed": "插件市场加载失败。请检查网络连接或系统代理，然后点击刷新重试。",
  "ext.market.addFailed": "添加市场失败。请检查来源地址和网络连接后重试。",
  "ext.market.removeFailed": "移除市场失败。请刷新后重试。",
  "ext.market.installFailed": "插件安装失败。请检查插件来源和网络连接后重试。",
"error.needTauri": "需要在 Tauri 窗口中选择目录",
  ...
  "summary.branches.open": "选择分支",
  "summary.branches.search": "搜索分支",
  "summary.branches.title": "分支",
  "summary.branches.uncommitted": "未提交：{count} 个文件",
  "summary.branches.create": "创建并检出新分支…",
  "summary.branches.createTitle": "创建并检出分支",
  "summary.branches.name": "分支名称",
  "summary.branches.invalid": "分支名不能为空或以“/”结尾。",
  "summary.branches.createAction": "创建并检出",
  ...
  "summary.subagents.stop": "停止子智能体“{name}”",
  "summary.subagents.stopFailed": "停止子智能体失败：{error}",
  "summary.subagents.running": "运行中（{count}）",
  "summary.subagents.failed": "需要处理（{count}）",
  "summary.subagents.interrupted": "已中断（{count}）",
  "summary.subagents.completed": "已完成（{count}）",
  "summary.empty": "暂无摘要内容",

  // 设置 → 个性化
  "settings.personalization.customInstructions": "全局自定义指令",
  "settings.personalization.description": "保存后从下一轮对话生效，无需重启。",
  "settings.personalization.learnMore": "了解更多",
  "settings.personalization.help":
    "KeenCode 会在每轮主 Agent 或子 Agent 执行前读取该文件。使用远程模型时，内容会随请求发送给你配置的模型供应商。",
  ...
  "settings.requests.reasoningTokens": "推理 Token",
  ...
  "settings.observability.title": "运行时观测",
  "settings.observability.description":
    "查看仅保存在本机且有界的运行时指标、追踪、启动阶段、资源与崩溃摘要。",
  "settings.observability.refresh": "刷新",
  "settings.observability.refreshing": "正在刷新…",
  "settings.observability.export": "导出脱敏 JSON",
  "settings.observability.exporting": "正在导出…",
  "settings.observability.loading": "正在加载运行时观测…",
  "settings.observability.unavailable": "运行时观测暂不可用。",
  "settings.observability.events": "事件",
  "settings.observability.traces": "追踪",
  "settings.observability.ttftP50": "首字节延迟 p50",
  "settings.observability.ttftP95": "首字节延迟 p95",
  "settings.observability.resources": "资源采样",
  "settings.observability.crashes": "崩溃记录",
  "settings.observability.dropped": "实时事件丢弃数",
  "settings.observability.startup": "启动阶段",
  "settings.observability.latestResource": "最近资源采样",
  "settings.observability.latestTrace": "最近追踪",
  "settings.observability.latestCrash": "最近崩溃",
  "settings.observability.noData": "未报告",
  "settings.observability.noCrashes": "暂无崩溃记录",
  "settings.observability.noResources": "暂无资源采样",
  "settings.observability.noStartup": "暂无启动阶段",
  "settings.observability.metric": "追踪名称",
  "settings.observability.count": "数量",
  "settings.observability.average": "平均值",
  "settings.observability.range": "范围",
  "settings.observability.cpu": "CPU",
  "settings.observability.processMemory": "进程内存",
  "settings.observability.privateMemory": "专用内存",
  "settings.observability.processCount": "跟踪进程数",
  "settings.observability.frontendMemory": "前端堆内存",
  "settings.observability.domNodes": "DOM 节点",
  "settings.observability.eventLoopLag": "事件循环延迟",
  "settings.observability.longTasks": "长任务",
  "settings.observability.phase": "阶段",
  "settings.observability.elapsed": "耗时",
  "settings.observability.status": "状态",
  "settings.observability.time": "时间",
  ...
  "chat.lastedFor": "持续了 {duration}",
  "chat.workingFor": "工作中 {duration}",
  "chat.workedFor": "已工作 {duration}",
  "chat.modelSwitched": "⇄ 模型已切换 {previous} → {model}",
  "chat.retryingAttempt": "正在进行第 {attempt}/{max} 次请求尝试",
  "chat.turnMetrics.label": "本轮延迟",
  "chat.turnMetrics.usage": "本轮用量",
  "chat.turnMetrics.usageValue": "用量 {value}",
  "chat.turnMetrics.time": "本轮用时",
  "chat.turnMetrics.timeValue": "用时 {value}",
  "chat.turnMetrics.input": "输入 Token（含缓存）",
  "chat.turnMetrics.output": "输出 Token",
  "chat.turnMetrics.reasoning": "推理 Token（包含在输出中）",
  "chat.turnMetrics.cacheRead": "缓存读取 Token",
  "chat.turnMetrics.outputSpeed": "输出速度（TPS）",
  "chat.turnMetrics.unknown": "未报告",
  "chat.turnMetrics.noUsage": "部分请求未报告用量，无法确定完整的本轮总量。",
  "chat.turnMetrics.notObserved": "本轮未记录用量统计。",
  "tool.imageViewed": "已查看 1 张图像",
  "tool.imagesViewed": "已查看 {count} 张图像",
  "tool.imageNumber": "图像 {count}",
  "chat.turnMetrics.totalTime": "总用时",
  "chat.turnMetrics.firstTokenLabel": "首 Token 延迟",
  "chat.turnMetrics.seconds": "{seconds}秒",
  "chat.turnMetrics.minutes": "{minutes}分{seconds}秒",
  ...
  "chat.error.compactUnavailable":
    "KeenCode 无法压缩对话上下文。请新建对话或选择其他模型。",
  ...
  "chat.codeLangText": "纯文本",
  "chat.codeWrap": "启用自动换行",
  "chat.codeUnwrap": "取消自动换行",
  "chat.codePreview": "打开图表预览",
  "chat.codePreviewTitle": "图表预览",
  "chat.codePreviewDescription": "交互式图表预览",
  "chat.codePreviewLoading": "正在渲染图表…",
  "chat.codePreviewZoomIn": "放大",
  "chat.codePreviewZoomOut": "缩小",
  "chat.codePreviewReset": "重置缩放",
  "sidebar.newSession": "新建对话",
