...
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "settings.analytics.time": "Time",
  "settings.analytics.model": "Model",
  "settings.analytics.requestMode": "Mode",
  "settings.analytics.duration": "Duration",
  "settings.analytics.tokens": "Tokens",
  "settings.analytics.details": "Details",
  "settings.analytics.sync": "Sync",
  "settings.analytics.async": "Async",
  "settings.analytics.turn": "Turn",
  "settings.analytics.estimated": "Estimated",
  ...
  "settings.analytics.sendAcknowledgement": "Send acknowledgement",
  "settings.analytics.firstSse": "First SSE",
  "settings.analytics.firstVisible": "First visible token",
  "settings.analytics.completed": "Completed",
  "settings.analytics.cacheHit": "Cache hit",
  "settings.analytics.notReported": "Not reported",
...
"error.needTauri": "需要在 Tauri 窗口中选择目录",
  ...
  "settings.analytics.time": "时间",
  "settings.analytics.model": "模型",
  "settings.analytics.requestMode": "模式",
  "settings.analytics.duration": "耗时",
  "settings.analytics.tokens": "Token",
  "settings.analytics.details": "详情",
  "settings.analytics.sync": "同步",
  "settings.analytics.async": "异步",
  "settings.analytics.turn": "回合",
  ...
  "settings.analytics.sendAcknowledgement": "发送确认",
  "settings.analytics.firstSse": "首 SSE",
  "settings.analytics.firstVisible": "首可见 Token",
  "settings.analytics.completed": "完成",
  "settings.analytics.cacheHit": "缓存命中",
  "settings.analytics.notReported": "未报告",
