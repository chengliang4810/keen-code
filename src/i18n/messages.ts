...
const en = {
  ...
  "addProject.sourceFolder": "Source folder",
  "addProject.chooseFolder": "Add a folder KeenCode can read and edit",
...
const zh: Record<MessageKey, string> = {
  ...
  "addProject.sourceFolder": "源文件夹",
  "addProject.chooseFolder": "添加 KeenCode 可读取和编辑的文件夹",
