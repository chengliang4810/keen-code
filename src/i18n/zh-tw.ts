...
"error.needTauri": "需要在 Tauri 視窗中選擇目錄",
  ...
  "summary.subagents.resume": "繼續此子智能體",
  "summary.subagents.resuming": "正在傳送繼續請求…",
  "summary.subagents.resumeQueued": "繼續請求已加入本工作階段佇列",
  "summary.subagents.resumeFailed": "無法傳送子智能體繼續請求",
  "summary.subagents.resumePrompt":
    "繼續既有子智能體「{name}」。你必須且只能呼叫一次 Agent 工具，並將 resume_thread_id 精確設為「{id}」：Agent(resume_thread_id: \"{id}\")。不要建立新的子智能體，不要變更該 ID；恢復後繼續完成其原任務並回報結果。",
  ...
  "chat.error.compactUnavailable":
    "KeenCode 無法壓縮對話內容。請新增任務或選擇其他模型。",
