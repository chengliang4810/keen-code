...
"error.needTauri": "需要在 Tauri 視窗中選擇目錄",
  ...
  "settings.analytics.sendAcknowledgement": "傳送確認",
  "settings.analytics.firstSse": "首 SSE",
  "settings.analytics.firstVisible": "首個可見 Token",
  "settings.analytics.completed": "完成",
  "settings.analytics.cacheHit": "快取命中",
  "settings.analytics.notReported": "未回報",
