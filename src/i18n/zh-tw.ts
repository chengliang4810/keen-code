...
export const zhTW: Record<MessageKey, string> = {
  ...
  "backgroundTasks.title": "背景任務",
  "backgroundTasks.cancel": "停止背景任務",
  "backgroundTasks.cancelAll": "停止所有背景任務",
  "backgroundTasks.kind.shell": "終端處理程序",
  "backgroundTasks.kind.agent": "子智能體",
  "backgroundTasks.kind.workflow": "工作流程",
  "error.details": "詳情",
...
"media.loadError": "應用程式內無法載入此媒體。",
  ...
  "agents.model.followSession": "繼承預設",
...
"error.needTauri": "需要在 Tauri 視窗中選擇目錄",
  ...
  "chat.turnMetrics.cacheHit": "快取命中 {value}",
